...
def parse_args():
    ...
    parser.add_argument("--synthetic_csv", type=str, default=None, help="CSV File containing the path to synthetic images and corresponding prompts.")
    parser.add_argument("--synthetic_img_dir", type=Path, default=None, help="Directory containing the synthetic images.")

    parser.add_argument("--synthetic_prompts_col", type=str, default="prompt", help="Column name in the CSV file containing the prompts.")
    parser.add_argument("--synthetic_img_col", type=str, default="img_savename", help="Column name in the CSV file containing the image paths.")
...
def main(args):
    ...
    prompts_df[args.synthetic_img_col] = prompts_df[args.synthetic_img_col].apply(lambda x: args.synthetic_img_dir.joinpath(x))
    ...
    for i in tqdm(range(len(prompts))):
        ...
        text = prompts[i]
        _score = round(image_text_inference.get_similarity_score_from_raw_data(
                    img_path, 
                    text
                ), 3)
