...
echo "Real Caption Column: $REAL_CAPTION_COL"
# echo "Synthetic Caption Column: $SYNTHETIC_CAPTION_COL"

CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES python metrics/fid_densenet_xrv.py \
                                                    ...
                                                    --shard=$SHARD \
                                                    --real_caption_col=$REAL_CAPTION_COL \
                                                    # --synthetic_caption_col=$SYNTHETIC_CAPTION_COL \
