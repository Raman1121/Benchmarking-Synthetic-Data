...
def main():
    ...
    print("Training Data Samples for {} dataset: {}".format(args.dataset_name, len(train_dataset)))
    print("Test Data Samples for {} dataset: {}".format(args.dataset_name, len(test_dataset)))
