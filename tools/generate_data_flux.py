...
def main(args):
    ...
    pipeline.load_lora_weights(
        ...
        adapter_name="flux_finetune_MIMIC" # Optional: Give your LoRA adapter a name
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_prompts_path", default=None)
    parser.add_argument("--batch_size", type=int, default=8)
    parser.add_argument("--savedir", type=str, default="generated_images")
    
    parser.add_argument("--base_model_id", type=str, default="black-forest-labs/FLUX.1-dev", help="Base model ID on HuggingFace")
    parser.add_argument("--ckpt_dir", type=str, default="OUTPUT_MIMIC_FLUX", help="Path to the directory containing your LoRA weights")
    parser.add_argument("--ckpt_name", type=str, default="flux_lora.safetensors", help="The specific filename of your LoRA weights")
