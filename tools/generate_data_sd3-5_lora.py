...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_model_id", type=str, default="stabilityai/stable-diffusion-3.5-medium", help="Base model ID on HuggingFace")
    parser.add_argument("--ckpt_dir", type=str, default="sd3-5_medium_lora", help="Path to the directory containing your LoRA weights")
    parser.add_argument("--ckpt_name", type=str, default="sd3-5_medium_lora.safetensors", help="The specific filename of your LoRA weights")
