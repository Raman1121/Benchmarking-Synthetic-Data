...
def main(args):
    ...
    try:
        ...
        # if("v1_4" in args.model_path.lower()):
        #     filename = "prompt_INFO_SDV1_4.csv"
        # elif("v1_5" in args.model_path.lower()):
        #     filename = "prompt_INFO_SDV1_5.csv"
        # elif("v2" in args.model_path.lower()):
        #     filename = "prompt_INFO_SDV2.csv"
        # elif("v2_!" in args.model_path.lower()):
        #     filename = "prompt_INFO_SDV2_1.csv"
        # else:
