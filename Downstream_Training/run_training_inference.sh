...
# export TRAIN_CSV="/data/Benchmarking-Synthetic-Data/MIMIC_Splits/training_data_15K_real.csv"
...
export TRAIN_CSV="/data/Benchmarking-Synthetic-Data/MIMIC_Splits/training_data_15K_synthetic.csv"
export REAL_IMAGE_DIR="/pvc/MIMIC_Dataset/physionet.org/files/mimic-cxr-jpg/2.0.0"
export SYNTHETIC_IMG_DIR="/pvc/SYNTHETIC_IMAGES/RadEdit"
export EXTRA_INFO="syn_data_RadEdit"

## 3. Training on 15K Real + Synthetic samples
# export TRAIN_CSV="/data/Benchmarking-Synthetic-Data/MIMIC_Splits/training_data_15K_mixed.csv"
# export REAL_IMAGE_DIR="/pvc/MIMIC_Dataset/physionet.org/files/mimic-cxr-jpg/2.0.0"
# export SYNTHETIC_IMG_DIR="/pvc/SYNTHETIC_IMAGES/RadEdit"
# export EXTRA_INFO="syn_data_RadEdit"

## 4. Training on 30K Real + Synthetic samples
# export TRAIN_CSV="/data/Benchmarking-Synthetic-Data/MIMIC_Splits/training_data_30K_augmented.csv"
# export REAL_IMAGE_DIR="/pvc/MIMIC_Dataset/physionet.org/files/mimic-cxr-jpg/2.0.0"
# export SYNTHETIC_IMG_DIR="/pvc/SYNTHETIC_IMAGES/RadEdit"
# export EXTRA_INFO="syn_data_RadEdit"

export TEST_CSV="/data/Benchmarking-Synthetic-Data/MIMIC_Splits/LLAVARAD_ANNOTATIONS_TEST.csv"
