...
# export T2I_MODEL="lumina"
# export BATCH_SIZE=758
# export TRAIN_CSV="/pvc/SYNTHETIC_IMAGES_NEW/lumina/generations_with_metadata.csv"
...
# export SYNTHETIC_IMG_DIR="/pvc/SYNTHETIC_IMAGES_NEW/lumina/generations_with_metadata.csv"
...
export TEST_CSV="/pvc/Benchmarking-Synthetic-Data/MIMIC_Splits/LLAVARAD_ANNOTATIONS_TEST.csv"
export REAL_IMAGE_DIR="/pvc/MIMIC_Dataset/physionet.org/files/mimic-cxr-jpg/2.0.0"
export SYNTHETIC_IMG_DIR="/pvc/SYNTHETIC_IMAGES_NEW/lumina"
